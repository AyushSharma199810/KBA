...
jq '.channel_group.groups.Application.groups."example-reg-com".values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "172.31.89.52","port": 7002}]},"version": "0"}}' autochannel_current_config.json > autochannel_modified_anchor_config.json
